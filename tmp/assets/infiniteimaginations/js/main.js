...
; browserify_shim__define__module__export__(typeof doT != "undefined" ? doT : window.doT);
...
; browserify_shim__define__module__export__(typeof pathjs != "undefined" ? pathjs : window.pathjs);
...
var isLargeDesktop = function isLargeDesktop() {
...
var $body = $('body'),
    $window = $(window),
    isMobileDevice = (0, _helper.isMobile)();
...
},{"./_helper":12,"mCustomScrollbar":9,"scrollMonitor":11}],14:[function(require,module,exports){
"use strict";

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

/*! modernizr 3.3.1 (Custom Build) | MIT *
 * https://modernizr.com/download/?-objectfit-touchevents-mq-setclasses !*/
!function (e, n, t) {
  function r(e, n) {
    ...
    var e = n.body;return e || (e = s(S ? "svg" : "body"), e.fake = !0), e;
  }function f(e, t, r, o) {
    var i,
        f,
        u,
        ...
        c = "modernizr",
        p = s("div"),
        d = a();if (parseInt(r, 10)) for (; r--;) {
      u = s("div"), u.id = o ? o[r] : c + (r + 1), p.appendChild(u);
    ...
    }for (var c, p, d, v, h, y = ["modernizr", "tspan", "samp"]; !N.style && y.length;) {
      c = !0, N.modElem = s(y.shift()), N.style = N.modElem.style;
    }for (d = e.length, p = 0; d > p; p++) {
      if (v = e[p], h = N.style[v], l(v, "-") && (v = u(v)), N.style[v] !== t) {
        if (i || r(o, "undefined")) return a(), "pfx" == n ? v : !0;try {
          N.style[v] = o;
        } catch (g) {}if (N.style[v] != h) return a(), "pfx" == n ? v : !0;
      }
    }return a(), !1;
  }function h(e, n, t, o, i) {
    var s = e.charAt(0).toUpperCase() + e.slice(1),
        a = (e + " " + j.join(s + " ") + s).split(" ");return r(n, "string") || r(n, "undefined") ? v(a, n, o, i) : (a = (e + " " + E.join(s + " ") + s).split(" "), p(a, n, t));
  }var y = [],
      g = [],
      ...
      w = C._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];C._prefixes = w;var x = function () {
    var n = e.matchMedia || e.msMatchMedia;return n ? function (e) {
      var t = n(e);return t && t.matches || !1;
    } : function (n) {
      var t = !1;return f("@media " + n + " { #modernizr { position: absolute; } }", function (n) {
        t = "absolute" == (e.getComputedStyle ? e.getComputedStyle(n, null) : n.currentStyle).position;
      }), t;
    };
  }();C.mq = x;var b = C.testStyles = f;Modernizr.addTest("touchevents", function () {
    var t;if ("ontouchstart" in e || e.DocumentTouch && n instanceof DocumentTouch) t = !0;else {
      ...
      j = C._config.usePrefixes ? z.split(" ") : [];C._cssomPrefixes = j;var T = function T(n) {
    var r,
        o = w.length,
  ...
  };C.atRule = T;var E = C._config.usePrefixes ? z.toLowerCase().split(" ") : [];C._domPrefixes = E;var P = { elem: s("modernizr") };Modernizr._q.push(function () {
    delete P.elem;
  });var N = { style: P.elem.style };Modernizr._q.unshift(function () {
    delete N.style;
  }), C.testAllProps = h;var k = C.prefixed = function (e, n, t) {
    return 0 === e.indexOf("@") ? T(e) : (-1 != e.indexOf("-") && (e = u(e)), n ? h(e, n, t) : h(e, "pfx"));
  };Modernizr.addTest("objectfit", !!k("objectFit"), { aliases: ["object-fit"] }), o(), i(y), delete C.addTest, delete C.addAsyncTest;for (var L = 0; L < Modernizr._q.length; L++) {
    Modernizr._q[L]();
...
var _header = require('../../../_modules/organisms/header/header');

var _header2 = _interopRequireDefault(_header);

var _navigation = require('../../../_modules/molecules/navigation/navigation');

var _navigation2 = _interopRequireDefault(_navigation);

var _history = require('../../../_modules/atoms/history/history');

var _history2 = _interopRequireDefault(_history);

var _galisteners = require('../../../_modules/atoms/galisteners/galisteners');

var _galisteners2 = _interopRequireDefault(_galisteners);
...
var Galisteners = function () {
    function Galisteners() {
        _classCallCheck(this, Galisteners);

        var that = this;
    }

    _createClass(Galisteners, [{
        key: 'init',
        value: function init() {
        ...
        key: 'gaPageView',
        value: function gaPageView() {
            // ga('send', 'pageview', document.location.hash);
        }
    }, {
        key: 'gaClickEvent',
        value: function gaClickEvent(c, l) {
...
var _pathjs = require('pathjs');

var _pathjs2 = _interopRequireDefault(_pathjs);

var _galisteners = require('../galisteners/galisteners');

var _galisteners2 = _interopRequireDefault(_galisteners);

var _listeners = require('../listeners/listeners');
...
var gaListeners = new _galisteners2.default();
...
var History = function () {
    function History() {
        ...
        _pathjs2.default.root("#/hello/");

        _pathjs2.default.map('#/hello/').enter(that.updateAnalytics).to(function () {
            listeners.exitCurrentSlide('hello');
            listeners.setActiveNav('hello');
        });

        _pathjs2.default.map('#/about/').enter(that.updateAnalytics).to(function () {
            listeners.exitCurrentSlide('about');
            listeners.setActiveNav('about');
        });

        _pathjs2.default.map('#/achievements/').enter(that.updateAnalytics).to(function () {
            listeners.exitCurrentSlide('achievements');
            listeners.setActiveNav('achievements');
        });

        _pathjs2.default.map('#/coding/').enter(that.updateAnalytics).to(function () {
            listeners.exitCurrentSlide('coding');
            listeners.setActiveNav('coding');
        });

        _pathjs2.default.map('#/design/').enter(that.updateAnalytics).to(function () {
        ...
        _pathjs2.default.map('#/case-study/:param').enter(that.updateAnalytics).to(function () {
        ...
        _pathjs2.default.map('#/contact/').enter(that.updateAnalytics).to(function () {
            listeners.exitCurrentSlide('contact');
            listeners.setActiveNav('contact');
        });

        _pathjs2.default.rescue(function () {
            listeners.exitCurrentSlide('error');
        });

        _pathjs2.default.listen();
    }
...
},{"../galisteners/galisteners":16,"../listeners/listeners":18,"pathjs":10}],18:[function(require,module,exports){
'use strict';
...
var _ScrollToPlugin = require('ScrollToPlugin');

var _ScrollToPlugin2 = _interopRequireDefault(_ScrollToPlugin);

var _countTo = require('countTo');
...
var _navigation = require('../../molecules/navigation/navigation');

var _navigation2 = _interopRequireDefault(_navigation);

var _helper = require('../../../_assets/infiniteimaginations/js/_helper.js');

var _material = require('../../../_assets/infiniteimaginations/js/_material.js');
...
var Listeners = function () {
    function Listeners() {
        ...
        // Funky decoder
        bHello = (0, _baffle2.default)('.hello h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bAbout = (0, _baffle2.default)('.about h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bAchievements = (0, _baffle2.default)('.achievements h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bCoding = (0, _baffle2.default)('.coding h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bDesign = (0, _baffle2.default)('.design h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bCaseStudy = (0, _baffle2.default)('.case-study h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bContact = (0, _baffle2.default)('.contact h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        bError = (0, _baffle2.default)('.error h1 .text', {
            characters: '█▓▒░',
            speed: 40
        });

        $('.skills__bar').each(function (i, v) {
            bSkillsLabel.push((0, _baffle2.default)('.skills__bar:nth-child(' + (i + 1) + ') .skills__label', { characters: '█▓▒░', speed: 40 }));
        });
    ...
    _createClass(Listeners, [{
        ...
        value: function createCaseStudyScrollMonitor() {
        ...
        value: function destroyCaseStudyScrollMonitor() {
            caseStudyWatcher.destroy();
        }
    }, {
        key: 'populateData',
        value: function populateData(json) {
        ...
        key: 'switchSlide',
        value: function switchSlide($url) {
        ...
        key: 'resetSlide',
        value: function resetSlide(slide) {
            TweenMax.set('.' + slide, {
                opacity: 1
            });
        ...
        value: function enterAchievements() {
        ...
        value: function exitCurrentSlide($url) {
        ...
        key: 'setActiveNav',
        value: function setActiveNav(navEl) {
...
},{"../../../_assets/infiniteimaginations/js/_helper.js":12,"../../../_assets/infiniteimaginations/js/_material.js":13,"../../molecules/navigation/navigation":19,"../galisteners/galisteners":16,"ScrollToPlugin":5,"baffle":1,"countTo":6}],19:[function(require,module,exports){
'use strict';
...
var _material = require('../../../_assets/infiniteimaginations/js/_material');

var _helper = require('../../../_assets/infiniteimaginations/js/_helper');
...
var Navigation = function () {
    ...
    _createClass(Navigation, [{
        ...
        value: function init() {
            ...
            $window.on('resize scroll', (0, _helper.debounce)(function () {
                that.backgroundResize();
            }, 250));
        }
    }, {
        key: 'tlHoverReverse',
        value: function tlHoverReverse() {
            tlHover.reverse();
        }
    }, {
        key: 'backgroundResize',
        value: function backgroundResize() {
...
},{"../../../_assets/infiniteimaginations/js/_helper":12,"../../../_assets/infiniteimaginations/js/_material":13}],20:[function(require,module,exports){
'use strict';
...
},{"../../../_assets/infiniteimaginations/js/_helper":12}]},{},[15])
