...
var RR = (function (parent, $) {
    ...
    var wrap = function () {
        ...
        $printableTable.each(function () {
            var $this = $(this);

            if ($this.length && !$this.parent().hasClass('table-wrapper') && $this.parent().hasHorizontalScrollBar()) {

                $this
                    .before('<button class="btn-print js-print-table">View Table</button>')
